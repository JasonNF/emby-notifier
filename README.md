...
- `emby.user_id` 为必填项，否则节目信息获取失败
- 请为机器人赋予 Telegram 群组的 **管理消息与删除权限**
- 若启用了 `allowed_group_id`，仅该群成员可使用命令
...
- **新增节目通知**  
  ![](./images/new_library_notify.png)

- **搜索节目（剧集）**  
  ![](./images/search_tv_series.png)
